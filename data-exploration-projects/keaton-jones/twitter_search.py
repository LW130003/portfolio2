...
def load_api():
    ...
    consumer_key = 'VnOOLf9fehUw6LsUOR1jpq3p3'
    consumer_secret = 'FFkvvz1rPyWOBl4CyQlFyhHeIU9I9NTzbftVhNClzMCX1X2RXn'
    access_token = '863243357828423681-cQAphU3OfEe3IdrZS6bEejO0RXoTXPG'
    access_secret = 'jhur2kwrGMHdzzPRjnhTZF6OpeRDO1f8QfYEUvYbp2QyB'
...
def main():
    ...
    ''' search variables: '''
    search_phrases = ['#KeatonJones', '#StopBullies', '#StandWithKeaton', 
                      '#KeatonsArmy']
